...
| V4-B (Hybrid-ABM) | `simulator.decisions.AhlfeldtArgmaxHybridEngine` | `aup.HybridDecisionEngine(...)` |
| V5.4 (LLM-ABM) | `simulator.decisions.AhlfeldtHierarchicalLLMEngine` (score-all + rebalance) | `aup.LLMDecisionEngine(response_format='score_all', rebalance_instruction=True, stage2_top_k_residences=10)` |
...
- Final V5.4 baseline + shock CSVs: `output/berlin_v5_score_all_*/per_zone.csv`
